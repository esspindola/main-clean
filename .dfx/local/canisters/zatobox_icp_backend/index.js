...
import { idlFactory } from './zatobox_icp_backend.did.js';
export { idlFactory } from './zatobox_icp_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ZATOBOX_ICP_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./zatobox_icp_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the zatobox_icp_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./zatobox_icp_backend.did.js")._SERVICE>}
 */
export const zatobox_icp_backend = createActor(canisterId);
