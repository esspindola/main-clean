...
const EditProductPage: React.FC = () => {
  ...
  const [variants, setVariants] = useState<VariantData>({
    Color: {
      ...
      values: [
        ...
        { id: '2', value: 'Azul', selected: true },
        { id: '3', value: 'Verde', selected: false },
        { id: '4', value: 'Negro', selected: true }
      ],
      newValue: '',
      showPanel: false
    },
    Tamaño: {
      ...
      values: [
        ...
        { id: '2', value: 'Mediano', selected: true },
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (response.success) {
        console.log('Product deleted successfully:', response.product);
        navigate('/inventory');
      } else {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-xl font-semibold text-text-primary md:hidden">Editar Producto</h1>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <button 
                ...
                disabled={saving}
                className={`bg-error hover:bg-error-600 text-white font-medium px-4 py-2 rounded-lg transition-colors ${
